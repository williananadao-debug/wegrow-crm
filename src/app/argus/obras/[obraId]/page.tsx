    ...
    <div>
      ...
      <main className="max-w-[1400px] mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Link href={`/argus/obras/${obra.id}/diario`} className="bg-white border border-[#e5e0d5] hover:border-[#d9861c]/50 rounded-2xl p-6 transition-all flex flex-col gap-3 shadow-sm">
            <div className="flex items-center justify-between">
              <div className="w-10 h-10 bg-[#fef3c7] rounded-xl flex items-center justify-center"><BookOpen size={18} className="text-[#d97706]" /></div>
              <ChevronRight size={16} className="text-[#c9c3b5]" />
            </div>
            <div>
