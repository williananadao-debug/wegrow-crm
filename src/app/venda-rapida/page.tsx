    ...
    return (
      <div className="p-4 md:p-8 pb-20 text-white">
        <div className="bg-[#0F172A] border border-white/10 rounded-3xl p-10 text-center">
          ...
          <p className="text-slate-400 font-bold text-sm">O módulo Venda Rápida não está ativo pra sua empresa ainda.</p>
        </div>
      </div>
    );
  }

  return <VendaRapida perfil={perfil} user={user} unidades={unidades} isLideranca={isLideranca} usersMap={usersMap} />;
}
