...
// Importação ajustada com o caminho absoluto (padrão do seu projeto)
...
export default function Navbar() {
  ...
  const [isCollapsed, setIsCollapsed] = useState(false); // Para o Desktop
  const [isMobileOpen, setIsMobileOpen] = useState(false); // Para o Celular
  ...
  return (
    <>
      {/* ========================================================= */}
      {/* 1. HEADER DO CELULAR (Fica no topo com os 3 tracinhos)    */}
      {/* ========================================================= */}
      ...
      {/* ========================================================= */}
      {/* 2. MENU LATERAL DO CELULAR (Desliza da esquerda)          */}
      {/* ========================================================= */}
      {isMobileOpen && (
        <div 
        ...
        <nav className="flex flex-col gap-2 flex-1 overflow-y-auto custom-scrollbar">
          {menuItems.map((item) => (
            <Link
              key={item.name}
              href={item.href}
              onClick={() => setIsMobileOpen(false)} // Fecha o menu ao clicar num link
      ...
      {/* ========================================================= */}
      {/* 3. MENU LATERAL DO DESKTOP (Intacto)                      */}
      {/* ========================================================= */}
      <aside 
        className={`hidden md:flex flex-col h-screen sticky top-0 bg-[#0B1120] border-r border-white/5 transition-all duration-300 z-50 ${isCollapsed ? 'w-[80px]' : 'w-[260px]'}`}
      >
        <button 
